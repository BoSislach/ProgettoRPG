public class Cura extends Pozione {

    public Cura(String nome, String descrizione, int peso, int utilizzo, boolean trasportabile, int valoreCura,String tipo) {
        super(nome, descrizione, peso, utilizzo, trasportabile, tipo,valoreCura);
    }
    ...
    public boolean curaPersonaggio(Personaggio personaggio){
